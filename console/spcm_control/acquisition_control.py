...
from console.spcm_control.interface_acquisition_parameter import Dimensions, AcquisitionParameter
...
class AcquistionControl:
    ...
    TODO: Implementation of logging mechanism. Use two logs: a high level one as lab-book and a detailed one for debugging. 
    """
