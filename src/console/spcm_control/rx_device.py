...
class RxCard(SpectrumDevice):
    ...
    def setup_card(self):
        ...
        # Setup digital input channel 3 for reference signal
        # SPC_DIGMODE1 is used to store the ref signal in channel 1
        sp.spcm_dwSetParam_i32(self.card, sp.SPCM_X3_MODE, sp.SPCM_XMODE_DIGIN)
        sp.spcm_dwSetParam_i32(self.card, sp.SPC_DIGMODE1, (sp.DIGMODEMASK_BIT15 & sp.SPCM_DIGMODE_X3))
